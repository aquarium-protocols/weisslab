...
def task_status_check t
  ...
  if t.task_prototype.name == "Sequencing Verification"
    ...
    errors.push "ENTRs needs to have the size of 2." if t.task_prototype.name == "Gateway Cloning" && argument_lengths != [2] # check if input size is 2 for yeast mating.
